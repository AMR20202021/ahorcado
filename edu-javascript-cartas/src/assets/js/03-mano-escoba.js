...
function repartir() {
    ...
    elemento1 = añadirCartaCompu(arrayComputadora[0], "assets/img/cartas/back-card.png", arrayComputadora[0], 'carta rotate-izq carta-en-mano');
    elemento2 = añadirCartaCompu(arrayComputadora[0], "assets/img/cartas/back-card.png", arrayComputadora[1], 'carta  carta-en-mano');
    elemento3 = añadirCartaCompu(arrayComputadora[0], "assets/img/cartas/back-card.png", arrayComputadora[2], 'carta rotate-der carta-en-mano');
    ...
    elemento4 = añadirCartaMesa(arrayMesa[3], "assets/img/cartas/" + arrayMesa[3] + ".png", arrayMesa[3], 'carta');
...
let bazaGanada = () => {
    ...
    arrayCartasMesa.forEach(carta => {
        elemento1 = añadirCartaCompu("cartac", "assets/img/cartas/back-card.png", barajada[0], 'carta-en-taco carta');
